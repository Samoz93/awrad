...
class _TestWidgetState extends State<TestWidget> {
  ...
  void _configureDidReceiveLocalNotificationSubject() {
    iosData.stream.listen((ReceivedNotification receivedNotification) async {
      await showDialog(
        context: context,
  ...
  void _configureSelectNotificationSubject() {
    selectedData.stream.listen((String payload) async {
      await Navigator.push(
        context,
  ...
  Future<void> _showInsistentNotification() async {
    ...
    var platformChannelSpecifics = NotificationDetails(
        androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);
    await flutterLocalNotificationsPlugin.show(
        3, 'insistent title', 'insistent body', platformChannelSpecifics,
        payload: 'item x');
  }
  ...
  Future<void> _repeatNotification(
      {String title = "title1", int id = 0}) async {
    var androidPlatformChannelSpecifics = AndroidNotificationDetails(
